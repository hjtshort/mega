(function($) {
  $(function() {
    ...
    $('#navbar-dark').on('ifChecked', function(event){ //Icheck's event for checkbox states
      $('.navbar').removeClass('navbar-primary navbar-danger navbar-success navbar-warning navbar-default');
      $('.navbar').addClass('navbar-dark');
    });
    $('#navbar-primary').on('ifChecked', function(event){ //Icheck's event for checkbox states
      $('.navbar').removeClass('navbar-dark navbar-danger navbar-success navbar-warning navbar-default');
      $('.navbar').addClass('navbar-primary');
    });
    $('#navbar-danger').on('ifChecked', function(event){ //Icheck's event for checkbox states
      $('.navbar').removeClass('navbar-dark navbar-primary navbar-success navbar-warning navbar-default');
      $('.navbar').addClass('navbar-danger');
    });
    $('#navbar-success').on('ifChecked', function(event){ //Icheck's event for checkbox states
      $('.navbar').removeClass('navbar-dark navbar-primary navbar-danger navbar-warning navbar-default');
      $('.navbar').addClass('navbar-success');
    });
    $('#navbar-warning').on('ifChecked', function(event){ //Icheck's event for checkbox states
      $('.navbar').removeClass('navbar-dark navbar-primary navbar-danger navbar-success navbar-default');
